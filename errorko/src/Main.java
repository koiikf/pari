...
public class Main {
    public static void main(String[] args) {
        String text = "::1 128.134.145.145 1.22.256.48 ::: -1.88 192.168.0.1a";
        ...
        Pattern pattern2 = Pattern.compile("((\\d|[1-9]\\d|1\\d{2}|2[0-4][0-9]|25[0-5])\\.){3}(\\d|[1-9]\\d||2[0-4][0-9]|25[0-5])");

        String[] numbers = text.split("  "); (двойной пробел)
